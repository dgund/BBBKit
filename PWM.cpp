...
#define PWM_SYSFS_ECAPPWM0_CHIP 0
#define PWM_SYSFS_ECAPPWM0_CHANNEL 0
#define PWM_SYSFS_ECAPPWM2_CHIP 5
#define PWM_SYSFS_ECAPPWM2_CHANNEL 0
...
#define PWM_SYSFS_PATH_ECAPPWM0 PWM_SYSFS_PATH_PWMCHIP(PWM_SYSFS_ECAPPWM0_CHIP)
#define PWM_SYSFS_PATH_ECAPPWM2 PWM_SYSFS_PATH_PWMCHIP(PWM_SYSFS_ECAPPWM2_CHIP)
...
#define PWM_SYSFS_ECAPPWM0 PWM_SYSFS_PWM(PWM_SYSFS_ECAPPWM0_CHIP, PWM_SYSFS_ECAPPWM0_CHANNEL)
#define PWM_SYSFS_ECAPPWM2 PWM_SYSFS_PWM(PWM_SYSFS_ECAPPWM2_CHIP, PWM_SYSFS_ECAPPWM2_CHANNEL)

#define PWM_SYSFS_DELAY 300000
...
const std::string pathMap[8] = {
    ...
    PWM_SYSFS_PATH_EHRPWM2,
    PWM_SYSFS_PATH_ECAPPWM0,
    PWM_SYSFS_PATH_ECAPPWM2,
};

const std::string nameMap[8] = {
    PWM_SYSFS_EHRPWM0A,
    PWM_SYSFS_EHRPWM0B,
    PWM_SYSFS_EHRPWM1A,
    PWM_SYSFS_EHRPWM1B,
...
const int channelMap[8] = {
    ...
    PWM_SYSFS_ECAPPWM0_CHANNEL,
    PWM_SYSFS_ECAPPWM2_CHANNEL,
};
